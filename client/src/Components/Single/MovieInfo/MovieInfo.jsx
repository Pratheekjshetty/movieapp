...
import FlexMovieItems from '../../FlexMovieItems/FlexMovieItems';
...
const MovieInfo = ({movie}) => {
  return (
    <div className='w-full xl:h-screen relative text-white'>
      <img src={`${movie.image}`} alt={movie.name} className='w-full hidden xl:inline-block h-full object-cover'/>
            ...
            <div className='col-span-3 flex flex-col gap-10'>
              ...
              <div className='grid sm:grid-cols-5 grid-cols-3 gap-4 p-6 bg-main border border-gray-800 rounded-lg'>
                ...
                <div className='sm:col-span-2 col-span-3 flex justify-end font-medium text-sm'>
                  <Link to={`${movie?.name}`} className='bg-dry hover:bg-subMain transitions border-2 border-subMain rounded-full flex-rows gap-4 w-full sm:py-3'>
