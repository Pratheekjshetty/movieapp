...
import { Input } from '../UsedInputs/UsedInputs'
  ...
  return (
    <Layout>
      <div className='container mx-auto px-2 my-24 flex-colo'>
        <div className='w-full 2xl:w-2/5 md:w-3/5 flex-colo p-8 gap-8 sm:p-14 bg-dry rounded-lg border border-border'>
          ...
          <p className='text-center text-border'>Already have an account?{" "}
            <Link to="/login" className='text-dryGray font-semibold ml-2'>Sign In
            </Link>
          </p>
        </div>
      </div>
